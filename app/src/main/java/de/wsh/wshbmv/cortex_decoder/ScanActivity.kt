...
//Easy Permission
    ...
    override fun receiveBarcodeCorners(p0: IntArray?) {
        Timber.tag(TAG).d("receiveBarcodeCorners")

    }

    override fun receiveMultipleBarcodeCorners(p0: MutableList<IntArray>?) {
        Timber.tag(TAG).d("receiveMultipleBarcodeCorners")

    }

    override fun barcodeDecodeFailed(p0: Boolean) {
        Timber.tag(TAG).d("barcodeDecodeFailed")

    }

    override fun multiFrameDecodeCount(p0: Int) {
        Timber.tag(TAG).d("multiFrameDecodeCount")
    ...
    override fun receivedMultipleDecodedData(
        ...
        Timber.tag(TAG).d("receivedMultipleDecodedData")

    }

    override fun receivedDecodedCodewordsData(p0: Codewords?) {
        Timber.tag(TAG).d("receivedDecodedCodewordsData")

    }

    override fun onDeviceIDResult(p0: Int, p1: String?) {
        Timber.tag(TAG).d("onDeviceIDResult")
